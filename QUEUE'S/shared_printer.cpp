...
void Printer()//Simulate the process of seeing a patient
{
	int sel,no;
    ...
    {
    	printf("1: Queuing 2: Use the printer 3: Checking the queuing 4:Queue sequence 5: Off duty Please select:"); 
    	...
    	switch(sel)
    	{
            ...
            case 2:
                   if(qu->front==NULL)//The team is empty
                       printf("There are no employees in line!\n");
                   else //The team is not empty
                   {
                   	   p=qu->front;
                   	   printf("employee %d uses the printer\n",p->data);
            ...
            case 4: //No more queues			 
                   ...
                   {
                   	   p=qu->front;
                   	   printf("employees are standing  in the following order:");
                   	   while(p!=NULL)
                   	   {
   	                   	   printf("%d  ",p->data);
   	                   	   p=p->next;
               ...
               case 5: //Off work  
                      if (qu->front!=NULL) //team
                           printf("employees in line, please come tomorrow!\n");
                      flag=false; //Retire
